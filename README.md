...
- [Hmbown/DeepSeek-TUI](https://github.com/Hmbown/CodeWhale) - Coding agent for DeepSeek models that runs in your terminal [Terminal] (33k⭐)
- [Hmbown/CodeWhale](https://github.com/Hmbown/CodeWhale) - Coding agent for DeepSeek models that runs in your terminal [Terminal] (33k⭐)
- [rohitg00/agentmemory](https://github.com/rohitg00/agentmemory) - #1 Persistent memory for AI coding agents based on real-world benchmarks [Copilot] (16k⭐)
- [manaflow-ai/cmux](https://github.com/manaflow-ai/cmux) - Ghostty-based macOS terminal with vertical tabs and notifications for AI coding agents [Terminal] (18k⭐)
- [can1357/oh-my-pi](https://github.com/can1357/oh-my-pi) - ⌥  AI Coding agent for the terminal — hash-anchored edits, optimized tool harness, LSP, Python, browser, subagents, and more [Terminal] (6k⭐)
