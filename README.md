...
_Last updated: 2025-12-23 01:14 UTC_
...
- [sudo-tee/opencode.nvim](https://github.com/sudo-tee/opencode.nvim) - neovim frontend for opencode - a terminal-based AI coding agent [Terminal] (296⭐)
...
- [lostintangent/conduit-release](https://github.com/lostintangent/conduit-release) - 🔌 A terminal-centric workspace manager (a "DIY-DE"), that's built for task parallelization with coding agents [Terminal] (181⭐)
...
- [xun082/DocFlow](https://github.com/xun082/DocFlow) - AI-powered docs ✍️ Built with Tiptap & Next.js — real-time collab ⚡, smart writing 🤖, and a flexible plugin system 🔌 [Vim/Neovim] (795⭐)
...
- [Danau5tin/terminal-bench-rl](https://github.com/Danau5tin/terminal-bench-rl) - GRPO training code which scales to 32xH100s for long horizon terminal/coding tasks. Base agent is now the top Qwen3 agent on Stanford's TerminalBench leaderboard. [Terminal] (316⭐)
