...
- [Hmbown/DeepSeek-TUI](https://github.com/Hmbown/CodeWhale) - Coding agent for open source, open weight models [Terminal] (34k⭐)
- [Hmbown/CodeWhale](https://github.com/Hmbown/CodeWhale) - Coding agent for open source, open weight models [Terminal] (34k⭐)
...
- [esengine/DeepSeek-Reasonix](https://github.com/esengine/DeepSeek-Reasonix) - DeepSeek-native AI coding agent for your terminal. Engineered around prefix-cache stability — leave it running. [Terminal] (6k⭐)
